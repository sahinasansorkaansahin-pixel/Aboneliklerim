...
class SubscriptionOneTimeWidget : AppWidgetProvider() {
    ...
    companion object {
        fun updateWidget(context: Context) {
            try {
                ...
                val ids = appWidgetManager.getAppWidgetIds(ComponentName(context, SubscriptionOneTimeWidget::class.java))
                if (ids.isNotEmpty()) {
                    val intent = Intent(context, SubscriptionOneTimeWidget::class.java).apply {
